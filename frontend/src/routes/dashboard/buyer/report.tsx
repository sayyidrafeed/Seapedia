    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="border border-border/80 shadow-sm relative overflow-hidden">
          ...
          <CardContent>
            <p className="text-xs text-muted-foreground">Average spending per completed order</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border border-border/80 shadow-sm">
        <CardHeader>
          ...
          <CardDescription>
            All your transactions. Only completed transactions contribute to the financial summary
            metrics above.
          </CardDescription>
        </CardHeader>
                ...
                return (
                  <div key={order.id} className="p-6 hover:bg-muted/30 transition-colors space-y-4">
                    ...
                    <div className="bg-muted/40 rounded-lg p-4 grid grid-cols-2 sm:grid-cols-5 gap-4 text-xs">
                      <div>
                        <span className="text-muted-foreground block mb-0.5">Subtotal</span>
                        <span className="font-bold text-foreground">
                          {formatCurrency(order.subtotal)}
                        </span>
                      </div>
                      <div>
                        <span className="text-muted-foreground block mb-0.5">Discount</span>
                      ...
                      <div className="col-span-2 sm:col-span-1 border-t sm:border-t-0 sm:border-l border-border/80 pt-2 sm:pt-0 sm:pl-4">
                        <span className="text-muted-foreground block mb-0.5">Final Total</span>
