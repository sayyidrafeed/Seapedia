              ...
              return (
                <div key={order.id} className="p-6 hover:bg-muted/30 transition-colors space-y-4">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="font-bold text-foreground text-sm capitalize">
                          {showStoreName && order.storeName ? order.storeName : 'Order ID'}
                        </span>
                      ...
                      <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                        ...
                        <span>{showStoreName ? dateStr : `Placed on: ${dateStr}`}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <span className="text-xs text-muted-foreground block">
                          {showStoreName ? 'Total Amount' : 'Your Revenue (Subtotal)'}
                        </span>
                  ...
                  <div className="bg-muted/40 rounded-lg p-4 grid grid-cols-2 sm:grid-cols-5 gap-4 text-xs">
                    <div>
                      <span className="text-muted-foreground block mb-0.5">{subtotalLabel}</span>
                    ...
                    <div>
                      <span className="text-muted-foreground block mb-0.5">
                        {showStoreName ? 'Discount' : 'Buyer Discount'}
                      </span>
