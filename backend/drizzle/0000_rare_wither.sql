...
--> statement-breakpoint
ALTER TABLE "active_session" ADD CONSTRAINT "active_session_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
